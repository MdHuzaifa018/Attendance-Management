    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
      <div className="relative w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto space-y-5">
          {/* Top KPI Card */}
          <div className="bg-gradient-to-r from-indigo-950 via-slate-900 to-slate-900 border border-indigo-500/30 rounded-2xl p-5 flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400">Continuous internal evaluation marks</p>
            </div>

            <div className="flex items-center gap-4">
              <div className="text-right">
                <span className="text-2xl font-black text-emerald-400">{overallPercentage}%</span>
                <p className="text-[10px] text-slate-400 font-semibold uppercase">Overall Score</p>
              </div>
              <div className="w-12 h-12 rounded-xl bg-indigo-500/20 border border-indigo-500/40 flex flex-col items-center justify-center">
                <span className="text-base font-black text-indigo-300 leading-none">{sgpa}</span>
                <span className="text-[8px] font-bold text-slate-400 mt-0.5">SGPA</span>
              </div>
            </div>
          </div>
