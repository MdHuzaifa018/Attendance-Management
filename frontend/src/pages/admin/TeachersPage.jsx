...
const DeleteConfirm = ({ teacher, onConfirm, onCancel, loading }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div className="relative w-full max-w-sm bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl p-6">
      ...
      <h3 className="text-white font-semibold mb-1">Delete teacher?</h3>
      <p className="text-slate-400 text-sm mb-5">
        This will permanently delete{" "}
        <span className="text-white font-medium">{teacher?.user?.name}</span>{" "}
          ...
          <>
                  ...
                  {teachers.map((teacher) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-slate-300 font-mono text-xs">
                        {teacher.phone || <span className="text-slate-500">—</span>}
                      </td>
            ...
            <div className="flex items-center justify-between px-6 py-3 border-t border-slate-800 text-xs text-slate-400">
              <span>
                ...
                <span className="text-white font-medium">{pagination.total}</span> teachers
              </span>
